...
$(function () {
    ...
    var $accordionlink = $('.accordion__link');
    var $accordionPlusMinus =$('.accordion__plus-minus');
    var $accordionContent = $('.accordion__content');

    $accordionlink.click(function () {
        $accordionlink.removeClass('accordion__link--active');
        $accordionContent.slideUp(100);
        $accordionPlusMinus.text('+');
        $(this).addClass('accordion__link--active')
            .find($accordionPlusMinus)
            .text('-');
        $(this).next($accordionContent).slideDown(1000);
    });
    ...
    // 1. 1. Массив скиллов (поле skills) всех людей, не должно быть повторяющихся скиллов, так же они должны быть отсортированы по алфавиту

    var skillMap1 = _.flatMap(data, 'skills');
    var skillUniq1 = _.uniq(skillMap1);
    var finalSkillArray1 = _.sortBy(skillUniq1);

    console.log("Задание 1:");
    console.log(finalSkillArray1);
    console.log("---------------------");
    ...
    var friendsSort2 = _.sortBy(data, 'friends.length');
    var nameMap2 = _.map(friendsSort2, 'name');
    ...
    var friendsMap3 = _.flatMap(data, 'friends');
    var friendsArray3 = _.flatMap(friendsMap3, 'name');
    var friendsUniq3 = _.uniq(friendsArray3);

    console.log("Задание 3:");
    console.log(friendsUniq3);
